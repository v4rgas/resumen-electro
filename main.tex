...
\begin{multicols*}{2}
  ...
  $$ V = Ed = \frac{Qd}{A\epsilon_0} \implies C = \frac{A\epsilon_0}{d}$$ 
	...
	Si se esta en presencia de \textbf{conductores isótropos}, la ley de Ohm puede ser escrita localmente como $$\vec{J}(\vec{x})=\sigma\vec{E}(\vec{x})$$
	...
	Cuano el interruptor esta cerrado por ley de la espira se tiene
